const address = "0xA0b73E1Ff0B80914AB6fe0444E65848C4C34450b".toLowerCase();
...
const abi = [
  ...
  },
  {
    inputs: [
      ...
      { name: "_secondarySaleReserveWallet", type: "address" },
      { name: "_mainNetLaunchIncentiveReserveWallet", type: "address" },
      { name: "_capitalReserveWallet", type: "address" },
      { name: "_ecosystemGrantsReserveWallet", type: "address" },
      { name: "_airdropReserveWallet", type: "address" }
    ],
    payable: false,
    stateMutability: "nonpayable",
    type: "constructor"
